      ...
      <div class="row gx-0 align-items-center">
          ...
          <div class="col-lg-4 text-center text-lg-end">
              <div class="d-inline-flex align-items-center" style="height: 45px;">
                  <a href="https://mosd.gov.ps/"><small class="me-3 text-dark"><i class="fa fa-user text-primary me-2"></i>وزارة
                          التنمية الإجتماعية</small></a>
      ...
      <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0 rtl">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
              <div class="navbar-nav ms-auto py-0">
                  <a href="https://mosd.gov.ps/" class="nav-item nav-link active">الرئيسية</a>
                  {{-- <a href="/projects" class="nav-item nav-link">البرامج والمشاريع</a> --}}
                  <a href="https://www.mosd.gov.ps/ar/about/1" class="nav-item nav-link">عن الوزارة</a>

                  <a href="https://www.mosd.gov.ps/ar/project-categories" class="nav-item nav-link">البرامج والمشاريع</a>
                  <a href="https://www.mosd.gov.ps/ar/legislations-laws" class="nav-item nav-link">التشريعات والقوانين</a>
                  <a href="https://www.mosd.gov.ps/ar/page/mosd-offices" class="nav-item nav-link">عناوين ومواقع مديريات وزارة التنمية الاجتماعية</a>
                  {{-- <a href="#" class="nav-item nav-link">البوابة الموحدة للمساعدات</a> --}}
                  <a href="https://www.mosd.gov.ps/ar/complaints-suggestions" class="nav-item nav-link">الشكاوي والإقتراحات </a>
