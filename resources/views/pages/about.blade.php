                ...
                <div class="row g-5 align-items-center">
                    <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                        <div>
                            ...
                            <p class="mb-4 p-about-us">
                                في إطار برنامج "أمل المستقبل" الذي يهدف إلى كفالة الأطفال الأيتام، يأتي مشروع رعاية الأيتام ليقدم دعمًا شاملاً ومتكاملاً لهذه الفئة، حيث يهدف المشروع إلى توفير الرعاية الصحية، النفسية، والاجتماعية والتعليمية للأطفال الأيتام ذوي الإعاقة، مما يساعدهم على تحقيق حياة كريمة ومستقلة. يشمل المشروع توفير السكن الآمن، الرعاية الطبية، والتأهيل، إضافة إلى تقديم برامج تعليمية وتدريبية تسهم في دمجهم بالمجتمع. كما يعزز المشروع من قدرات مقدمي الرعاية عبر ورش عمل متخصصة، ويشجع المجتمع على فهم وتقبل الأيتام من ذوي الإعاقة من خلال حملات توعوية.
                            </p>
                            <p class="mb-4 p-about-us">
                                يعد مشروع التعافي الطبي جزءاً من برنامج "أمل المستقبل" ويسعى إلى مساعدة الأطفال الأيتام الذين يواجهون تحديات صحية أو نفسية كبيرة تتطلب مراحل طويلة من العلاج والتعافي. يقدم المشروع رعاية طبية متكاملة تشمل جلسات العلاج الطبيعي، إعادة التأهيل، والدعم النفسي، إضافة إلى المتابعة المستمرة لضمان عودة الأطفال إلى حياتهم الطبيعية بشكل تدريجي. ويعمل فريق متخصص من الأطباء والمعالجين على تصميم برامج علاجية فردية لكل طفل، إلى جانب دعم عائلاتهم لإشراكهم في العملية العلاجية، مما يعزز بيئة داعمة تسهم في تحقيق تعافٍ مستدام للأطفال الأيتام وتؤهلهم للمستقبل.
                            </p>
                            <p class="mb-4 p-about-us">
                                يهدف مشروع الأسر البديلة، ضمن برنامج "أمل المستقبل"، إلى توفير بيئة أسرية مستقرة وداعمة للأطفال الأيتام الذين لا تتوفر لهم الرعاية الأسرية. ويسعىإلى دمج هؤلاء الأطفال في أسر بديلة تؤمن لهم الرعاية، الحنان، والإشراف التربوي السليم، مما يعزز من فرص نموهم بشكل صحي وسليم.
                            </p>
                            <p class="mb-4 p-about-us">
                                ويشمل المشروع اختيار الأسر وفق معايير محددة لضمان استقرار الطفل، بالإضافة إلى تقديم التدريب والدعم المستمر للأسر البديلة، لضمان أن تلبي احتياجات الطفل النفسية والاجتماعية.
                            </p>
                            <p class="mb-4 p-about-us">
                                ويسعى مشروع الأسر البديلةإلى توفير حياة كريمة للأطفال الأيتام ومنحهم فرصة لبناء مستقبل مشرق ومستقل ضمن بيئة أسرية آمنة ومفعمة بالحب والاهتمام.
                            </p>
                        </div>
                    </div>

                    <div class="col-xl-5 wow fadeInRight about-img" data-wow-delay="0.2s">
